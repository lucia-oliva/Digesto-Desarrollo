...
const endpointRows = [
  ...
  [ROUTE_GROUPS.DEPENDENCIA, "GET", "/api/dependencia/:id", POLICIES.SUPER_ADMIN, ENDPOINT_LIFECYCLE.LEGACY],
  [ROUTE_GROUPS.DEPENDENCIA, "POST", "/api/dependencia", POLICIES.SUPER_ADMIN, ENDPOINT_LIFECYCLE.LEGACY],
  [ROUTE_GROUPS.DEPENDENCIA, "DELETE", "/api/dependencia/:id", POLICIES.SUPER_ADMIN, ENDPOINT_LIFECYCLE.LEGACY],
  [ROUTE_GROUPS.DEPENDENCIA, "PUT", "/api/dependencia/:id", POLICIES.SUPER_ADMIN, ENDPOINT_LIFECYCLE.LEGACY],
