...
const ACCION_BADGE = {
  1: {
    label_entrada: "Modificada por",
    label_salida: "Modifica",
    className: "badge-warning",
  },
  2: {
    label_entrada: "Derogada por",
    label_salida: "Deroga",
    className: "badge-error",
  },
  3: {
    label_entrada: "Complementada por",
    label_salida: "Complementa",
...
function useVariant(forcedVariant) {
  ...
  return useMemo(() => {
    if (
      forcedVariant &&
      ["admin", "consejo", "public"].includes(forcedVariant)
    ) {
                  ...
                  {vinculosEntradaVisibles.map((v) => {
                    ...
                    return (
                      <button
                        ...
                        onClick={() =>
                          navigate(basePath + v.normativa_complementaria)
                        }
                  ...
                  {vinculosSalidaVisibles.map((v) => {
                    ...
                    return (
                      <button
                        ...
                        onClick={() =>
                          navigate(basePath + v.normativa_original)
                        }
