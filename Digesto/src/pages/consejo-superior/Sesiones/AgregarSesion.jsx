  ...
  const fields = useMemo(
    () => [
      ...
      },
      {
        ...
        type: "date",
        validate: (v) =>
          !v ? "Seleccione la fecha de la sesión." : "",
      },
      {
        key: "orden",
        ...
        validate: (file) => {
          if (!file) {
            return "Adjunte el PDF del orden del día.";
          }
          ...
          if (file.size > 20 * 1024 * 1024) {
            return "El PDF no puede superar los 20 MB.";
          }
    ...
    () => [
      {
        ...
        items: [
          ...
          "Archivo en PDF, hasta 20 MB.",
        ],
      },
      {
        title: "Sugerencias",
        items: [
          "Revise que el PDF se abra correctamente.",
          "Mantenga una convención de nombres consistente.",
        ],
      },
    ],
    [],
      ...
      try {
        ...
        setGlobalError(
          error?.response?.data?.msg ||
            "No se pudo guardar la sesión. Intentá nuevamente.",
        );
      } finally {
        setLoading(false);
      }
