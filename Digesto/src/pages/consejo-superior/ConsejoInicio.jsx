...
const ConsejoInicio = () => {
  return (
    <section
      className="relative w-full min-h-screen pt-16 bg-center bg-cover bg-no-repeat"
      style={{ backgroundImage: `url(${consejoImg})` }}
    >

      <div className="absolute inset-0 bg-black/30" />


      <div className="relative z-10 flex items-center px-6 sm:px-12 lg:px-24 py-12">
        <div className="bg-white/80 backdrop-blur-md text-gray-800 max-w-2xl lg:max-w-xl p-8 rounded-xl shadow-xl ring-1 ring-black/10 space-y-6">
          <h1 className="text-3xl sm:text-4xl font-bold leading-tight text-primary">
            Consejo Superior
          </h1>
