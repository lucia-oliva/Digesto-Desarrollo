      ...
      <div className="relative z-20 h-full flex items-center px-6 sm:px-12 lg:px-24">
        <div className="bg-white/80 backdrop-blur-md text-gray-800 max-w-2xl lg:max-w-xl p-8 rounded-xl shadow-xl ring-1 ring-black/10 space-y-6">
          ...
          <p className="text-gray-700 text-lg">
            El Consejo Superior es el órgano colegiado de gobierno
            universitario, encargado de tomar decisiones clave para el
            desarrollo académico e institucional de la Universidad.
          </p>
          ...
          <div className="space-y-1">
            ...
            <p className="text-sm text-gray-700">
              ...
              diciembre. También puede convocar sesiones extraordinarias fuera
              de ese período.
            </p>
          </div>
        </div>
