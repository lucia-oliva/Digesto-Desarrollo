...
function Carga() {
  ...
  const validarPaso2 = () => {
    ...
    if (!formData.dependencia.trim())
      nuevosErrores.dependencia = "Seleccione una dependencia.";
    ...
    if (!formData.archivo_pdf)
      nuevosErrores.archivo_pdf = "Adjunte un archivo PDF.";
        ...
        >
          <div className="flex space-x-4">
            ...
            <div>
              ...
              />
              {errores.anio && (
                <p className="text-red-500 text-sm mt-1">{errores.anio}</p>
              )}
            </div>
          </div>
          ...
          <div>
            ...
            {errores.dependencia && (
              <p className="text-red-500 text-sm mt-1">{errores.dependencia}</p>
            )}
          </div>
          <div>
          ...
          <div>
            ...
            />
            {errores.archivo_pdf && (
              <p className="text-red-500 text-sm mt-1">{errores.archivo_pdf}</p>
            )}
          </div>
          <div>
                            ...
                            if (yaExiste) {
                              ...
                              return {
                                ...
                                normativas_modificadas:
                                  prev.normativas_modificadas.map((n) =>
