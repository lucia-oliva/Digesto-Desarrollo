...
export const normativaColumns = [
  {key: "numero", label: "N°", className: "text-center font-[Raleway] text-gray-700 text-md sm:text-sm" ,hiddenIn: ["busqueda","ver","admin", "crear_edit"]},
  ...
  { key: "visitas", label: "Visitas",className:"text-center text-gray-700 font-[Raleway] text-lg sm:text-md", hiddenIn: ["busqueda","crear_edit"] },
];
